...
\class{Corso di Telerilevamento Geo-Ecologico}
%\date{}
...
{\Large\textbf{Indici di Variabilità}}
\parbox{\linewidth}{
    \includegraphics[width=.3\linewidth]{DVI.png}
    \label{Fig: DVI_2018-2022}
    \includegraphics[width=.3\linewidth]{NDVI.png}
    \label{Fig: NDVI_2018-2022}
    \includegraphics[width=.3\linewidth]{NDRE.png}
